...
class CallPythonForModelInfo {
    public static void main(String[] args) {
        try {
            ...
            String pythonScriptPath = "/Users/shivaji/Documents/code/CP2530/final.py";
            ...
            System.out.println("The best model is: " + bestModelName + " with a ROC AUC Score of: " + bestModelRocAucScore);
